...
public class Harian extends AppCompatActivity  implements ListView.OnItemClickListener {
  ...
  private void showEmployee(){
    ...
    ListAdapter adapter = new SimpleAdapter(
            Harian.this, list, R.layout.list_item2,
            new String[]{konfigurasi.TAG_TGL,konfigurasi.TAG_PRE1,konfigurasi.TAG_DIS1,konfigurasi.TAG_PRE2,konfigurasi.TAG_DIS2},
            new int[]{R.id.tgl, R.id.pre1, R.id.dis1, R.id.pre2, R.id.dis2});
  ...
  private void getJSON(){
    class GetJSON extends AsyncTask<Void,Void,String> {
      ...
      protected void onPreExecute() {
        super.onPreExecute();
        loading = ProgressDialog.show(Harian.this,"Loadig......","Please wait...",false,false);
      }
      ...
      protected String doInBackground(Void... params) {
        ...
        String s = rh.sendGetRequestParam(konfigurasi.URL_GET_QUIZ,eml);
