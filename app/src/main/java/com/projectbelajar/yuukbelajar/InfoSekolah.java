...
public class InfoSekolah extends AppCompatActivity implements ListView.OnItemClickListener{
  ...
  private void showEmployee(){
    ...
    ListAdapter adapter = new SimpleAdapter(
            InfoSekolah.this, list, R.layout.list_info,
  ...
  private void getJSON(){
    class GetJSON extends AsyncTask<Void,Void,String>{
      ...
      protected void onPreExecute() {
        super.onPreExecute();
        loading = ProgressDialog.show(InfoSekolah.this,"Loadig......","Please wait...",false,false);
      }
      ...
      protected String doInBackground(Void... params) {
        ...
        String s = rh.sendGetRequestParam(konfigurasi.URL_GET_ALL,eml);
