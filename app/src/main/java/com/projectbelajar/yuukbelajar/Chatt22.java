...
public class Chatt22 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chatt22);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Chatt22.this, Tabbed.class);
                startActivity(i);
            }
        });
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Chatt22.this,"send message...","wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                Intent i = new Intent(Chatt22.this, Chatt2.class);
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Chatt22.this, "Loadig......", "Please wait...", false, false);
            }
    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String pss = jo.getString(konfigurasi.TAG_PSS);
                ...
                //Toast.makeText(getApplicationContext(), pss, Toast.LENGTH_LONG).show();
                ...
                employees.put(konfigurasi.TAG_PSS,pss);
        ...
        ListAdapter adapter = new SimpleAdapter(
                Chatt22.this, list, R.layout.list_chatt,
