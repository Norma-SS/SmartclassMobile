...
public class Chatt extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wlkls = intent.getStringExtra(konfigurasi.EMP_WLKLS);
        eml = intent.getStringExtra(konfigurasi.EMP_ID);
        kdchatt = intent.getStringExtra(konfigurasi.EMP_KDCHATT);
        //Toast.makeText(getApplicationContext(), kdchatt, Toast.LENGTH_LONG).show();
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Chatt.this, Tabbed.class);
                startActivity(i);
            }
        });
    ...
    private void getJSON() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Chatt.this, "Loadig......", "Please wait...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                JSON_STRING = s;
                //Toast.makeText(getApplicationContext(), "hallooo "+eml, Toast.LENGTH_LONG).show();
                showEmployee();
            }
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                Chatt.this, list, R.layout.list_chatt,
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Chatt.this,"send message...","wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Intent i = new Intent(Chatt.this, Chatt2.class);
